...
const Tools = () => {
    const getTools = () => {
        return [{
                ...
                id: 1,
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Tools/Cloudly.avif",
                label: "Weather",
                name: "Cloudly"
            }, {
                icon: "fa-solid fa-calculator-simple",
                id: 2,
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Tools/Mathio.avif",
                label: "Calc",
                name: "Mathio"
            }, {
                icon: "fa-solid fa-piggy-bank",
                id: 3,
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Tools/Cashy.avif",
                label: "Bank",
                name: "Cashy"
            }, {
                icon: "fa-solid fa-plane",
                id: 4,
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Tools/Fly-er-io-ly.avif",
                label: "Travel",
                name: "Fly-er-io-ly"
            }, {
                icon: "fa-solid fa-gamepad-modern",
                id: 5,
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Tools/Gamey.avif",
                label: "Games",
                name: "Gamey"
            }, {
                icon: "fa-solid fa-video",
                id: 6,
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Tools/Chatty.avif",
                label: "Video Chat",
                name: "Chatty"
            }].map((tool) => {
            const styles = {
...
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                ...
                id: 1,
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Restaurants/The%20best%20burgers%20in%20town.avif",
                title: "Burgers"
            }, {
                desc: "The worst ice-cream around",
                id: 2,
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Restaurants/The%20worst%20ice-cream%20around.avif",
                title: "Ice Cream"
            }, {
                desc: "This 'Za be gettin down",
                id: 3,
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Restaurants/pizza.avif",
                title: "Pizza"
            }, {
                desc: "BBQ ain't need no rhyme",
                id: 4,
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Restaurants/bbq.avif",
                title: "BBQ"
            }].map((restaurant) => {
            const styles = {
...
const Movies = () => {
    const getMovies = () => {
        return [{
                ...
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Movies/Protectors%20of%20the%20Milky%20Way.avif",
                title: "Protectors of the Milky Way"
            }, {
                desc: "Some people leave their holes to disrupt some things.",
                id: 2,
                icon: "fa-solid fa-hat-wizard",
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Movies/Hole%20People.avif",
                title: "Hole People"
            }, {
                desc: "A boy with a dent in his head tries to stop a bad guy. And by bad I mean bad at winning.",
                id: 3,
                icon: "fa-solid fa-broom-ball",
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Movies/Pot%20of%20Hair.avif",
                title: "Pot of Hair"
            }, {
                desc: "A long drawn out story of some people fighting over some space. Cuz there isn't enough of it.",
                id: 4,
                icon: "fa-solid fa-starship-freighter",
                image: "https://raw.githubusercontent.com/Amirmahdi003/App-Menu-With-Lock-Screen/main/Movies/Area%20Fights.avif",
                title: "Area Fights"
            }].map((movie) => {
            const styles = {
